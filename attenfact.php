...
<body background="fo.jpg" style="background-repeat:no-repeat; background-size:100%">
...
<form action="site2.php" method="post">
  ...
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Select Subject&nbsp;:&nbsp;
<select name="subjec" style="width:100;height:30;">
...
$uidd=$_SESSION['uuuid'];
      $result = mysql_query("SELECT * FROM user  WHERE uid='".$uidd."'");
      ?>
	  <br>
	  <br>
	  <br>
...
$i=1;
 ...
 $id=  $row['id'];
            ...
            "<tr>
              ...
              <td>{$row['uid']}<input type='checkbox' checked='checked' name='id[]' value ='{$row['uid']}'></td>
